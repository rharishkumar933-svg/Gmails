...
PAYOUT_UPI_LOG_GROUP_ID = os.getenv("PAYOUT_UPI_LOG_GROUP_ID", "")
if PAYOUT_UPI_LOG_GROUP_ID:
    try:
        PAYOUT_UPI_LOG_GROUP_ID = int(PAYOUT_UPI_LOG_GROUP_ID)
    except ValueError:
        pass

PAYOUT_CRYPTO_LOG_GROUP_ID = os.getenv("PAYOUT_CRYPTO_LOG_GROUP_ID", "")
if PAYOUT_CRYPTO_LOG_GROUP_ID:
    try:
        PAYOUT_CRYPTO_LOG_GROUP_ID = int(PAYOUT_CRYPTO_LOG_GROUP_ID)
    except ValueError:
        pass
