...
@Client.on_message(filters.text & filters.private & ~filters.command(["start", "admin", "check", "addbalance", "removebalance", "addholdbalance", "removeholdbalance", "waittime", "checkholds", "broadcast", "stats", "user", "payout", "commission", "setup", "minimumpayout", "admincommands", "login", "margin", "setmargin", "reset"]))
